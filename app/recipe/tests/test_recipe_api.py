...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        recipe = create_recipe(user=self.user,
                               title='Sample Recipe Title', link=original_link)
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'description': 'New  is sample recipe',
            'time_minutes': 30,
            'price': Decimal('2.50'),
        }
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        for tag in payload['tags']:
            recipe.tags.filter(user=self.user,
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        for ingredients in payload['ingredients']:
            exists = recipe.ingredients.filter(name=ingredients['name'],
                                               user=self.user).exists()
            self.assertTrue(exists)
